        ...
        <div class="col-6">
            <section id=form>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="NamaMobil" name="NamaMobil" value="<?= $select['nama_mobil'] ?>" >
                </div>
                <div class="mb-3">
                    <label for="NamaPemilik" class="form-label"><strong>Nama Pemilik</strong></label>
                    <input type="text" class="form-control" id="NamaPemilik" name="NamaPemilik" value="<?= $select['pemilik_mobil'] ?>">
                </div>
                <div class="mb-3">
                    <label for="Merk" class="form-label"><strong>Merk</strong></label>
                    <input type="text" class="form-control" id="Merk" name="Merk" value="<?= $select['merk_mobil']?>">
                </div>
                <div class="mb-3">
                    <label for="tanggal" class="start"><strong>Tanggal Beli</strong></label>
                    <input type="date" name="tanggal" class="form-control" id="tanggal" name="tanggal" value="<?= $select['tanggal_beli'] ?>">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <tr>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="statusp" value="lunas" id="lunas" <?php echo $select['status_pembayaran'] == 'lunas' ? 'checked' : '' ?>>
                            <label class="form-check-label" for="flexRadioDefault1">Lunas&emsp;&emsp;</label>
                        </div>
                        </td>
                        <td>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="statusp" value="belumlunas" id="belumlunask" <?php echo $select['status_pembayaran'] == 'belumlunas' ? 'checked' : '' ?>>
